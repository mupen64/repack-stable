...
Cette action est irréversible.
    ...
    VARWATCH_INTENDED_YAW_LABEL = 'Yaw ciblé',
    VARWATCH_INTENDED_YAW = '%s (O : %s)',
    VARWATCH_H_SPEED_LABEL = 'Vitesse H',
    VARWATCH_H_SPEED = '%s (S : %s)',
    VARWATCH_H_SLIDING_LABEL = 'Vitesse de glisse H',
    VARWATCH_Y_SPEED_LABEL = 'Vitesse Y',
    VARWATCH_SPD_EFFICIENCY_LABEL = 'Efficacité Vitesse',
    ...
    VARWATCH_XZ_MOVEMENT_LABEL = 'Mouvement XZ',
    VARWATCH_ACTION_LABEL = 'Action',
    VARWATCH_UNKNOWN_ACTION = 'Action inconnue ',
    VARWATCH_RNG_LABEL = 'RNG',
    VARWATCH_RNG_INDEX_LABEL = 'Index',
    VARWATCH_GLOBAL_TIMER_LABEL = 'Compteur global',
    VARWATCH_DIST_MOVED_LABEL = 'Distance parcourue',
    -- Memory addresses
